  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-7 product-page-couple wow fadeInLeft" data-wow-duration="2s" data-wow-delay=".5s">
        <h1><?php echo $item['carName'];?></h1>
        <?php if(isset($item['images'])){?>
        <img class="primary-image" src="<?php echo DEFAULT_URL; ?>/image_resizer.php?img=<?php echo urlencode(DEFAULT_URL.'/uploads/car/'.$item['images'][0]); ?>&newWidth=581&newHeight=431" class="img-responsive" style="width:100%">
                ...
                <!-- Carousel items -->
                    <div class="carousel-inner">
                        ...
                        for($imageCount = 1;$imageCount<=$totalImages;$imageCount++){
                            ...
                            ?>
                            <div class="col-md-3 paroduct-carosel"><img src="<?php echo DEFAULT_URL.'/uploads/car/'.$item['images'][$imageCount - 1]; ?>" alt="Image" style="max-width:100%;" class="center"></div>
                            <?php
            ...
            <!-- Hide Show Section -->
                <div class="col-md-12 product-hide-show-form no-padding">
                    ...
                    <iframe src="<?php echo DEFAULT_URL?>/paypal_inventory_payment.php?car_id=<?php echo $id;?>" width="510" height="680" scroll="no" style="border: none;"></iframe>                
                </div>
                    ...
                    <div class="tab-content">
                      <div class="tab-pane fade in active" id="tab1default">
                         <div class="col-md-12 tabs-fst-body no-padding">
                            <h3><?php echo $item['carName']; ?>. Stock ID: <?php echo $item['stock_id']; ?></h3> 
                            <div class="col-md-4 frst-text">
                               <h2>Vin &nbsp  &nbsp <span><?php echo $item['vin']; ?></span></h2>
                            </div>

                            <div class="col-md-5 middle-text">    
                              <h2>Mileage &nbsp  &nbsp <span><?php echo number_format($item['mileage'],2);?> Mi</span></h2>
                            </div>

                            <div class="col-md-3 prdtlast-text">   
                              <h2>Prix  &nbsp &nbsp <span> <?php echo $common->CurrencyConverter($item['price']);?> €</span></h2>
                            </div>
                            ...
                            <div class="col-md-12 tab-cardescription-1 no-padding">
                              ...
                              <div class="col-md-2 side-border">
                                <h2><?php echo $common->getOptionNameById($item['manufacturer']);?></h2>
                              </div>
                            ...
                            <div class="col-md-12 tab-cardescription-2 no-padding">
                              ...
                              <div class="col-md-2 col-xs-6 side-border-bottom">
                                <h2><?php echo $common->getOptionNameById($item['drivetrain']);?></h2>
                              </div>
                            </div> <!-- col-md-12 -->
                            ...
                            <div class="col-md-12 tab-cardescription-1 no-padding">
                              ...
                              <div class="col-md-2 col-xs-6 side-border">
                                <h2><?php echo $common->getOptionNameById($item['extColor']);?></h2>
                              </div>
                              ...
                              <div class="col-md-2 col-xs-6 side-border-bottom">
                                <h2><?php echo $common->getOptionNameById($item['interColor']);?></h2>
                              </div>
                            </div> <!-- col-md-12 -->
                            ...
                            <div class="col-md-12 tab-cardescription-2 no-padding">
                              ...
                              <div class="col-md-2 col-xs-6 side-border">
                                <h2><?php echo $common->getOptionNameById($item['transmission']);?></h2>
                              </div>
                              ...
                              <div class="col-md-2 col-xs-6 side-border">
                                <h2><?php echo $common->getOptionNameById($item['fuel']);?></h2>
                              </div>
                              ...
                              <div class="col-md-2 col-xs-6 side-border-bottom">
                                <h2><?php echo $common->getOptionNameById($item['bodyStyle']);?></h2>
                              </div>
                            </div> <!-- col-md-12 -->
                            ...
                            <div class="col-md-12 tab-cardescription-1 no-padding">
                              ...
                              <div class="col-md-2 side-border col-xs-6">
                                <h2><?php echo $item['vehicle_title'];?></h2>
                              </div>
                              ...
                              <div class="col-md-2 col-xs-6 side-border-saller no-padding">
                                <h2><?php echo $item['for_sale_by'];?></h2>
                              </div>
                              ...
                              <div class="col-md-1 side-border-bottom">
                                <h2><?php echo $item['number_cylinders'];?></h2>
                              </div>
                            </div> <!-- col-md-12 -->
                            ...
                            <div class="col-md-12 tab-cardescription-1 no-padding">
                              ...
                              <div class="col-md-9 col-xs-6 no-left-padding">
                                <h2> <?php echo $item['warranty'];?>Vehicle does NOT have an existing warranty</h2>
                              </div>
                            </div> <!-- col-md-12 -->
                            ...
                            <div class="col-md-12 tab-cardescription-2 no-padding">
                              ...
                              <div class="col-md-8 col-xs-6 no-left-padding">
                                <h2> <?php echo $item['power_options'];?></h2>
                              </div>
                            </div> <!-- col-md-12 -->
                         </div>   
                      </div>
...
<input type="hidden" id="carprice" value="<?php echo $common->ConvertPrice($carPrice);?>" />
<script>
