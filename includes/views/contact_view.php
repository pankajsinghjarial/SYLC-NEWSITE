<section class="media-header-section"></section>
<!-- End header section -->
<section class="contact-section">
	...
	<div class="row">
		...
		<form action="" id="sylContactForm" name="sylContactForm" method="POST" >
			...
			<input type="text" class="form-control" name="fax" id="exampleInputContact" placeholder=" ">
		    </div>
		    <div class="col-md-12 form-group">
			<label for="exampleInputTelephone">Telephone:</label>
			<input type="text" class="form-control" name="phone" id="exampleInputTelephone" placeholder=" ">
		    </div>
		    <div class="col-md-12 form-group">
		    ...
		    <div class="col-md-12 form-group">
			<div class="checkbox">
			    <label  for="contacAgreement">
				<input type="checkbox" name="contacAgreement"> J’ai lu et j’accepte expressement la  <a href="javascript:void(0);">politique de  confidential</a>
			    </label>
			</div>
		    </div>
		...
		<?php echo html_entity_decode($ContactPageContent['desc']); ?> 
