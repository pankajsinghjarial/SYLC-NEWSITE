...
<nav class="navbar navbar-default">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="list-unstyled list-inline">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="<?php echo DEFAULT_URL;?>/products?products=inventory" title="Notre Inventaire"><i class="fa fa-angle-right"></i> Notre Inventaire </a></li>
            ...
            <li class='last'><a href="/media" title="Média"> Média</a></li>
          </ul>
        </div>
      </div>
  </ul>
      ...
      <a class="navbar-brand" href="<?php echo DEFAULT_URL; ?>/" title="<?php echo DEFAULT_URL; ?>"><img src="<?php echo DEFAULT_URL; ?>/images/logo.png" class="img-responsive"></a>


      <ul class="nav navbar-nav">
        <div id='cssmenu'>
          <ul class="list-unstyled list-inline">
            <li><a href="car-review.html" title="Revues Automobiles">Revues Automobiles </a></li>
            <li><a href="/logistic" title="Logistique">Logistique </a></li>
