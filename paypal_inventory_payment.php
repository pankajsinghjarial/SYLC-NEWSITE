                        ...
                        <div class="col-md-12 product-page-couple wow fadeInLeft" data-wow-duration="2s" data-wow-delay=".5s">
                            <div class="col-md-12 product-hide-show-form no-padding">
                                ...
                                <form class="form-horizontal" method="POST" onsubmit="javascript:return validatePayment(event);">
                                    ...
                                    <input type="hidden" id="item" name="item" value="<?php echo strtoupper($item['carName']);?>" />
                                    <input type="hidden" id="itemID" name="itemID" value="<?php echo $item['id'];?>" />
                                    <input type="hidden" id="caryear" name="caryear" value="<?php echo $item['madeYear'];?>" />
                                    <input type="hidden" id="make" name="make" value="<?php echo $item['manufacturer'];?>" />
                                    <input type="hidden" id="model" name="model" value="<?php echo $item['model'];?>" />
                                    <input type="hidden" id="carprice" name="carprice" value="<?php echo $common->ConvertPrice($item['price']);?>" />
                                    <input type="hidden" id="trim" name="trim" value="<?php echo (isset($item['trim']))?$item['Trim']:'NA';?>" />
                                    <input type="hidden" id="interior_color" name="interior_color" value="<?php echo (isset($item['interColor']))?$item['interColor']:'NA';?>" />
                                    <input type="hidden" id="exterior_color" name="exterior_color" value="<?php echo (isset($item['extColor']))?$item['extColor']:'NA';?>" />
                                </form>
                            </div>
                        </div>
                    </div><!--  col-md-7 -->
