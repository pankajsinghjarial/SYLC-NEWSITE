...
include_once(LIST_ROOT_ADMIN."/accessories/code/accessories_multiple_delete_code.php"); 
include(LIST_ROOT_ADMIN_INCLUDES."/views/admin_header.php");
include(LIST_ROOT_ADMIN."/accessories/view/accessories_multiple_delete_view.php");
