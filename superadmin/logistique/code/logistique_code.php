...
$obj_setting = new common();
$total_rows = $obj_setting->numberOfRows('content_page' , "page_name='Logistique'"); //number of rows in pages table
$allAccessories = $obj_setting->customQuery("SELECT * FROM  content_page where page_name='Logistique' order by $field $orderby limit $eu, $limit");
