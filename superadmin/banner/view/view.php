                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th width="12%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Publish</a></th>
				  ...
				  if($total_rows > 0){
				  $ii =1;
				  while($getPageData = mysqli_fetch_object($all_pages)){ 
				  ?>
                    <tr <?php if($ii%2==0) echo 'class="alternate-row"';?>>
                      ...
                      <td><?php if($getPageData->type == 1 ){ echo "Slide Show"; } else if($getPageData->type == 2){ echo "Advertisement"; }
					  		else if($getPageData->type == 3){ echo "Partners"; } else if($getPageData->type == 4){ echo "Gaurantee"; }?></td>
