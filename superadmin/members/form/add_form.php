...
<div id="content" >
  ...
  <form action="<?=$_SERVER['REQUEST_URI'];?>" method="post" name="add_form" id="add_form" enctype="multipart/form-data" >
      ...
      <div id="dashboard"><span class="page_head">Add New Product</span></div>
   ...
   <?php if($errorMsg!='') {?>
     ...
     Yes <input type="radio" name="publish" id="publish_1" value="1" checked="checked" />&nbsp;&nbsp;&nbsp; No <input type="radio" name="publish" id="publish_2" value="0" />
