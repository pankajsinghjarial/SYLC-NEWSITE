                  ...
                  <td><!-- start id-form -->
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                     ...
                     <!--  <tr>
						...
						<?php if($doc_exists){ ?>
						<tr>
                      	<th valign="top">Existing Document :</th>
							<td>
								<a href="<?php echo $docfile;?>" target="_blank" ><u><b> View Document </b></u></a>
							</td>
							<td></td>
						</tr>
						<?php }?>
					  <tr>
                      	<th valign="top">New Document :</th>
							<td>
								<input type="file" name="document" id="documentPdf"  />
