                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th width="17%" class="table-header-options line-left minwidth-1"><a href="javascript:void(0)">Type</a> </th>
                      <th width="17%" class="table-header-options line-left"><a href="javascript:void(0)">Make</a></th>
                      <th width="17%" class="table-header-date line-left"><a href="javascript:void(0)">Model</a></th>
                      <th width="17%" class="table-header-options line-left"><a href="javascript:void(0);">Year</a></th>
                      <th width="17%" class="table-header-options line-left"><a href="javascript:void(0);">Updated</a></th>
                      <th width="17%" class="table-header-options line-left"><a href="javascript:void(0);">Options</a></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php 
				  ...
				  ?>
                    <tr <?php if($ii%2==0) echo 'class="alternate-row"';?>>
                      ...
                      <td><?php echo date(DEFAULT_DATE_FORMAT,$getPageData->updated);?></td>
