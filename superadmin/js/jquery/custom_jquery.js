...
$(document).ready(function() {
	...
	$(".close-red").click(function () {
		$("#message-red-login").fadeOut("slow");
	});
	$(".close-blue").click(function () {
		$("#message-blue").fadeOut("slow");
	});
	$(".close-green").click(function () {
		$("#message-green-login").fadeOut("slow");
	});
	$(".close-green").click(function () {
		$("#message-green").fadeOut("slow");
	});
	$(".close-blue1").click(function () {
		$("#message-blue1").fadeOut("slow");
	});
	$(".close-yellow1").click(function () {
		$("#message-yellow1").fadeOut("slow");
	});
});
