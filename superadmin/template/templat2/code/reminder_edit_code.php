...
$fetchSetting 			= $obj_setting->read('template', 'id = 4');
...
if($_SERVER['REQUEST_METHOD']=='POST')
    {
		  ...
		  if($error){
		  ...
		  else
		    {
				...
				$update_site		=	$obj_setting->update('template', $dataArr,' id=4');
				echo '<script>location.href="'.DEFAULT_ADMIN_URL.'/template/templat2/index.php'.$addToUrl.'";</script>'; 
				exit;
			}
		}
unset($obj_setting);
