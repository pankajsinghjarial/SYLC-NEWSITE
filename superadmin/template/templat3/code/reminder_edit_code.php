...
$fetchSetting 			= $obj_setting->read('template', 'id = 5');
...
if($_SERVER['REQUEST_METHOD']=='POST')
    {
		  ...
		  if($error){
		  ...
		  else
		    {
				...
				$update_site		=	$obj_setting->update('template', $dataArr,' id=5');
				echo '<script>location.href="'.DEFAULT_ADMIN_URL.'/template/templat3/index.php'.$addToUrl.'";</script>'; 
				exit;
			}
		}
unset($obj_setting);
