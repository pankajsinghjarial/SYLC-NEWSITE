                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th width="25%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Page Title</a> </th>
                      <th width="7%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Published</a></th>
                      <th width="37%" class="table-header-repeat line-left"><a href="javascript:void(0)">Description</a></th>
                      <th width="18%" class="table-header-date line-left"><a href="javascript:void(0)">Creation Date</a></th>
				  ...
				  ?>
                    <tr <?php if($ii%2==0) echo 'class="alternate-row"';?>>
                      ...
                      <td><?php echo pageStatus($getPageData->publish);?></td>
                      <td><?php echo trim(str_replace('&nbsp;','',substr(strip_tags($getPageData->desc),0,100))).'....';?></td>
                      <td><?php echo date(DEFAULT_DATE_FORMAT,$getPageData->creation_date);?></td>
                      <td><a href="edit.php?id=<?php echo $getPageData->id.$addToPagging;?>" title="Edit" class="icon-1 info-tooltip"></a>
                        <?php if($getPageData->can_delete==1){?>
                        <a href="delete.php?pageid=<?php echo $getPageData->id.$addToPagging;?>" title="Delete" class="icon-2 info-tooltip"></a>
                        <?php } ?>
                      </td>
                    </tr>
                    <?php $ii++; 
