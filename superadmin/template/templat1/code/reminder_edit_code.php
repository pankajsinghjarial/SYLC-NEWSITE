...
$fetchSetting 			= $obj_setting->read('template', 'id = 3');
...
if($_SERVER['REQUEST_METHOD']=='POST')
    {
		  ...
		  if($error){
		  ...
		  else
		    {
				...
				$update_site		=	$obj_setting->update('template', $dataArr,' id=3');
				echo '<script>location.href="'.DEFAULT_ADMIN_URL.'/template/templat1/index.php'.$addToUrl.'";</script>'; 
				exit;
			}
		}
unset($obj_setting);
