<?php
	...
	include_once(LIST_ROOT_ADMIN."/presentation/code/presentation_actionbanners_code.php"); 
	include(LIST_ROOT_ADMIN_INCLUDES."/views/admin_header.php");
	include(LIST_ROOT_ADMIN."/presentation/form/presentation_actionbanners_form.php");
