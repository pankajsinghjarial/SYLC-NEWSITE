                  ...
                  <td><!-- start id-form -->
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                      <tr>
						...
						<tr>
							<th valign="top">Top Banner:</th>
							<td>
								<input type="file" name="topbanner" />
								<input type="hidden" name="oldtopimage" value="<?php echo $topBanner;?>"/>
								<label><?php echo $topBanner;?></label>							
							</td>
							</td>
						...
						<tr>
							<th valign="top">Side Banner:</th>
							<td>
								<input type="file" name="sidebanner" />
								<input type="hidden" name="oldsideimage" value="<?php echo $sideBanner;?>"/>
								<label><?php echo $sideBanner;?></label>							
							</td>
							</td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						...
						<tr>
							...
							<td valign="top"><input type="submit" value="submit" name="submit" class="form-submit" />
							  <input type="button" class="form-reset" onclick="javascript:location.href='<?php echo DEFAULT_ADMIN_URL; ?>/presentation/actionbanners.php'"/>
							</td>
							<td></td>
                        </tr>
                    </table>
