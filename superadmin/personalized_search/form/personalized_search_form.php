...
<div id="content-outer">
  ...
  <div id="content">
    <div id="page-heading">
      <h1>Personalized Search Manager</h1>
    </div>
                      ...
                      <tr>
						...
						<tr>
							...
							<td valign="top"><input type="submit" value="submit" name="submit" class="form-submit" />
							  <input type="button" class="form-reset" onclick="javascript:location.href='<?php echo DEFAULT_ADMIN_URL; ?>/personalized_search/index.php'"/>
							</td>
							<td></td>
                        </tr>
                    </table>
