...
if($_SERVER['REQUEST_METHOD']=='POST')
    {
		  ...
		  if($error){
		  ...
		  else
		    {
				...
				$dataArr = array('name'=>$name,'slug'=>$slug,'desc'=>$desc, 'publish'=>$publish,'metatitle'=>$metatitle,'metakeyword'=>$metakeyword,'metadescription'=>$metadescription,'can_delete'=>$can_delete,'creation_date'=>$currentTimestamp);
