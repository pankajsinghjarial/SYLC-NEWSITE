...
<div id="content-outer">
  ...
  <div id="content">
    <!--  start page-heading -->
    <div id="page-heading">
      <!-- <div style="float:right;"><form action="<?php //echo $page_name;?>" method="post">
      	<input type="submit" name="exportMYSQLData" value="Export This Section to CSV File" />
      </form></div> -->
      <h1>Newpage</h1>
      ...
      <tr>
        ...
        <td><!--  start content-table-inner ...................................................................... START -->
          <div id="content-table-inner">
			...
			<th width="25%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)" style="background:none">Date</a> </th>
                      <th width="25%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Name</a> </th>
                      <th width="20%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Adresse</a></th>
                      <th width="5%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Code Postal</a></th>
                      <th width="20%" class="table-header-repeat line-left"><a href="javascript:void(0)">Email</a></th>
                      <th width="16%" class="table-header-date line-left"><a href="javascript:void(0)">Phone Number</a></th>
				  ...
				  if($total_rows > 0){
				  $ii =1;
				  while($getPageData = mysql_fetch_object($all_pages)){  //echo "<pre>";var_dump($getPageData);die; 
				  ?>
			...
			<td><?php echo ($getPageData->created  != "0000-00-00 00:00:00") ? date("d / m / Y",strtotime($getPageData->created)) : '';?></td>
                      <td><?php echo $getPageData->name;?></td>
                        <td><?php echo $getPageData->address;?></td>
                      <td><?php echo $getPageData->code_postal;?></td>
                      <td><?php echo $getPageData->email;?></td>
                      <td><?php echo $getPageData->phone;?></td>
                      <!-- <td><?php //if($getPageData->mail_date != ''){ echo date("d-M-Y h:i:s",$getPageData->created);} else { echo "Mail not sent yet.";}?>
                      <?php //if($getPageData->status == 0){?>
                      <a title="Mail Not Sent"><img src="<?php //echo DEFAULT_ADMIN_URL ?>/images/wait.jpg" /></a>
                      <?php // }else{?>
                      <a title="Mail Sent"><img src="<?php //echo DEFAULT_ADMIN_URL ?>/images/ok.jpg" /></a>
                       <?php //} ?>
                      </td> -->
