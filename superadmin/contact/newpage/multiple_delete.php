...
include_once(LIST_ROOT_ADMIN."/contact/newpage/code/contact_multiple_delete_code.php"); 
include(LIST_ROOT_ADMIN_INCLUDES."/views/admin_header.php");
include(LIST_ROOT_ADMIN."/contact/newpage/view/multiple_delete_view.php");
