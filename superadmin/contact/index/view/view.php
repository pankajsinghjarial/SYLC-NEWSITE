...
<div id="content-outer">
  ...
  <div id="content">
    ...
    <div id="page-heading">
      ...
      <h1>Index Page Inquiry Lead Manager</h1>
        ...
        <td><!--  start content-table-inner ...................................................................... START -->
          <div id="content-table-inner">
			...
			<th width="25%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)" style="background:none">Date</a> </th>
                      ...
                      <th width="20%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Type</a></th>
			...
			<td><?php echo ($getPageData->created  != "0000-00-00 00:00:00") ? date("d / m / Y",strtotime($getPageData->created)) : '';?></td>
                      <td><?php echo $getPageData->name;?></td>
                        <td><?php if($getPageData->type == 4 ){ echo "index Page Inquiry"; }?></td>
                      ...
                      <td><?php if($getPageData->mail_date != ''){ echo date("d-M-Y h:i:s",$getPageData->mail_date);} else { echo "Mail not sent yet.";}?>
