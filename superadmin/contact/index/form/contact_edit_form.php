                    ...
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                      ...
                      <tr>
                        ...
                        <td><?php if($getSetting->mail_date != ''){ echo date("d-M-Y h:i:s",$getSetting->mail_date);} else { echo "Mail not sent yet.";}?></td>
                          ...
                          <tr>
                        <th valign="top">Inquiry For:</th>
                        <td>Index Page Inquiry</td>
                        </tr>
                     <?php /*?>  <tr>
                       ...
                       <tr>
                        <th valign="top"></th>
                        <td><input type="image" src="../../images/forms/back.jpg" onclick="location.href='<?php echo DEFAULT_ADMIN_URL; ?>/contact/index/index.php'" /></td>
