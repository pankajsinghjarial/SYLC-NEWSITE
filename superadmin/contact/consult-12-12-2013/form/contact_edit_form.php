                  ...
                  <td><!-- start id-form -->
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                      ...
                      <tr>
                        ...
                        <td><?php echo $getSetting->time; ?></td>
                        </tr>
                        <tr>
                        <th valign="top">Question:</th> 
                        <td><?php echo htmlspecialchars_decode($getSetting->question);?> </td>
                        </tr>
                       <tr>
                       ...
                       <tr>
                        <th valign="top"></th>
                        <td><input type="image" src="../../images/forms/back.jpg" onclick="location.href='<?php echo DEFAULT_ADMIN_URL; ?>/contact/consult/index.php'" /></td>
