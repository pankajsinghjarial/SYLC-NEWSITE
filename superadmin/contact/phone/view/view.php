                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th width="16%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)" style="background:none">Date</a></th>
                      <th width="40%" class="table-header-repeat line-left"><a href="javascript:void(0)">Phone Number</a></th>
                      <th width="26%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Type</a></th>
				  ...
				  ?>
                    <tr <?php if($ii%2==0) echo 'class="alternate-row"';?>>
                      ...
                      <td><?php echo date("d-m-Y h:i a",strtotime($getPageData->add_date))?></td>
