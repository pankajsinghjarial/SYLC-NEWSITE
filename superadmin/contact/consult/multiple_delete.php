...
include_once(LIST_ROOT_ADMIN."/contact/consult/code/contact_multiple_delete_code.php"); 
include(LIST_ROOT_ADMIN_INCLUDES."/views/admin_header.php");
include(LIST_ROOT_ADMIN."/contact/consult/view/multiple_delete_view.php");
