        ...
        <td><!--  start content-table-inner ...................................................................... START -->
          <div id="content-table-inner">
            ...
            <div id="table-content">
			  ...
			  ?>
              <!--  start product-table ..................................................................................... -->
              <form id="mainform" action="media_multiple_delete.php" method="post">
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th width="63%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Title</a> </th>
                       <th width="15%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Type</a> </th>
                  ...
                  <tbody>
					...
					?>
						<tr <?php if ($ii%2==0) echo 'class="alternate-row"';?>>
						  ...
						  <td><?php if ($getPageData->type == 0){echo 'Video';}else{echo 'Photo';};?></td>
						  <td><a href="actionmedia.php?id=<?php echo $getPageData->id;?>" title="Edit" class="icon-1 info-tooltip"></a>
							 <a onclick="return confirm('Are you sure you want to delete.');" href="media_delete.php?id=<?php echo $getPageData->id;?>&action=delete" title="Delete" class="icon-2 info-tooltip"></a>
						  </td>
						</tr>
                    <?php $ii++; 
				 	  } 
