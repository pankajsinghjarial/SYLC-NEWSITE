                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th width="78%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Tab Title</a> </th>
                  ...
                  <tbody>
					...
					?>
						<tr <?php if ($ii%2==0) echo 'class="alternate-row"';?>>
						  ...
						  <td>
							<a href="articles.php?cat_id=<?php echo $getPageData->id;?>" title="View Related Articles" class="icon-1 info-tooltip"></a>
							<a href="actionnews_category.php?id=<?php echo $getPageData->id;?>" title="Edit" class="icon-1 info-tooltip"></a>
							 <a onclick="return confirm('Are you sure you want to delete.');" href="news_category_delete.php?id=<?php echo $getPageData->id;?>&action=delete" title="Delete" class="icon-2 info-tooltip"></a>
						  </td>
						</tr>
                    <?php $ii++; 
				 	  } 
