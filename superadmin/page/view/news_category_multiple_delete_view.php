                  ...
                  <thead>
                    <tr>
					  ...
					  <?php if ($total_rows > 0){
                      			...
                      			echo 'Are you sure, You want to delete these Categories?';
                    ...
                    <tr>
                      <th valign="top">
                        <input type="hidden" value="<?php echo $totalIds;?>" name="id" />
                        <input type="hidden" value="delete" name="action" />
                        <input type="submit" value="" class="form-submit" />
                        <input type="button" value="" class="form-reset" onclick="javascript:location.href='news.php';"/>						
                      </th>
                    </tr>
                  </thead>
                </table>
