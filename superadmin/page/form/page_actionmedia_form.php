                  ...
                  <td><!-- start id-form -->
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                      <tr>
						...
						<tr>
							<th valign="top">Media Title:</th>
							<td><input class="inp-form" name="mediaTitle" id="mediaTitle" value="<?php echo $mediaTitle ;?>" /></td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						</tr>				

						<tr id="urltr">
							<th valign="top">Youtube URL:</th>
							<td><input class="inp-form" name="url" id="url" value="<?php echo $url ;?>" /></td>
							<td>
						...
						<tr>
							...
							<input type="hidden" name="oldimage" value="<?php echo $bannerImage;?>"/>
							<label><?php echo $bannerImage;?></label>
							</td>
							</td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						...
						<tr>
							...
							<td valign="top"><input type="submit" value="submit" name="submit" class="form-submit" />
							  <input type="button" class="form-reset" onclick="javascript:location.href='<?php echo DEFAULT_ADMIN_URL; ?>/page/media.php'"/>
							</td>
							<td></td>
                        </tr>
                    </table>
