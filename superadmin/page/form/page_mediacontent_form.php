                    ...
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                      <tr>
						...
						<tr>
							...
							<td>
								<textarea rows="" cols="" class="form-textarea" name="content" id="metakeyword"><?php echo $content;?></textarea>
							</td>
							</td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						...
						<tr>
							...
							<td valign="top"><input type="submit" value="submit" name="submit" class="form-submit" />
							  <input type="button" class="form-reset" onclick="javascript:location.href='<?php echo DEFAULT_ADMIN_URL; ?>/page/mediacontent.php'"/>
							</td>
							<td></td>
                        </tr>
                    </table>
