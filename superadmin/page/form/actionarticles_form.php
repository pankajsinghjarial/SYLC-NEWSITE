...
<div id="content-outer">
  ...
  <div id="content">
    <div id="page-heading">
      <h1><?php echo $heading;?> Article</h1>
    </div>
                  ...
                  <td><!-- start id-form -->
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                      <tr>
								...
								<select name="category_id">
									...
									<?php
										while($getPageData = mysql_fetch_object($allCategories)) {
											$selected = '';
											if($categoryId == $getPageData->id) {
												$selected = 'selected=selected';
											}
											echo '<option value="'. $getPageData->id .'" '.$selected.'>'.$getPageData->category_name."</option>'";
										}
						...
						<tr>
							<th valign="top">Article Title:</th>
							<td><input class="inp-form" name="title" id="title" value="<?php echo $title ;?>" /></td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						</tr>
                   ...
                   <tr>
							...
							<td valign="top"><input type="submit" value="submit" name="submit" class="form-submit" />
							  <input type="button" class="form-reset" onclick="javascript:location.href='<?php echo DEFAULT_ADMIN_URL; ?>/page/news_category.php'"/>
							</td>
							<td></td>
                        </tr>
                    </table>
