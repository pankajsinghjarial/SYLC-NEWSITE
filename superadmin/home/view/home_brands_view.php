        ...
        <td><!--  start content-table-inner ...................................................................... START -->
          <div id="content-table-inner">
            ...
            <div id="table-content">
			  ...
			  ?>
              <!--  start product-table ..................................................................................... -->
              <form id="mainform" action="banner_multiple_delete.php" method="post">
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th width="45%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Title</a> </th>
                      <th width="12%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Status</a></th>
                  ...
                  <tbody>
                    <?php 
					  if ($total_rows > 0) {
						$ii = 1;
						while($getBrandData = mysqli_fetch_object($allBrands)){ 
					?>
                    <tr <?php if ($ii%2==0) echo 'class="alternate-row"';?>>
                      <td><input  type="checkbox" name="allselect[]" class="case" id="allselect<?php echo $getBrandData->id;?>" value="<?php echo $getBrandData->id;?>"/></td>
                      <td><?php echo $getBrandData->brand_name;?></td>
                      <td></td>
                      <td></td>
                                            
                      <td><a href="actionbrand.php?id=<?php echo $getBrandData->id;?>" title="Edit" class="icon-1 info-tooltip"></a>
                         <a onclick="return confirm('Are you sure you want to delete.');" href="banner_delete.php?id=<?php echo $getBrandData->id;?>&action=delete" title="Delete" class="icon-2 info-tooltip"></a>
                      </td>
                    </tr>
                    <?php $ii++; 
				 	  } 
