                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th width="33%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Status</a></th>                     
                  ...
                  <tbody>
                    <?php 
					  if ($total_rows > 0) {
						$ii = 1;
						while($getPageData = mysql_fetch_object($allBanners)){ 
					?>
                    <tr <?php if ($ii%2==0) echo 'class="alternate-row"';?>>
                      ...
                      <td><?php echo $getPageData->content;?></td>
                      <td><?php if ($getPageData->status == 0 ){ echo "Deactive"; } else { echo "Active"; }?></td>                                   
                      <td><a href="banner.php?id=<?php echo $getPageData->id;?>" title="Edit" class="icon-1 info-tooltip"></a>
                         <a onclick="return confirm('Are you sure you want to delete.');" href="banner_delete.php?id=<?php echo $getPageData->id;?>&action=delete" title="Delete" class="icon-2 info-tooltip"></a>
                      </td>
                    </tr>
                    <?php $ii++; 
				 	  } 
