                    ...
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                      <tr>
						...
						<tr>
							...
							<td><input type="text" class="inp-form" name="brand_name" id="brand_name" value="<?php echo $brandName ;?>" /></td>
						...
						<tr>
							...
							<td valign="top"><input type="submit" value="submit" name="submit" class="form-submit" />
							  <input type="button" class="form-reset" onclick="javascript:location.href='<?php echo DEFAULT_ADMIN_URL; ?>/home/brands.php'"/>
							</td>
							<td></td>
                        </tr>
                    </table>
