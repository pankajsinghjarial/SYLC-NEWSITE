...
<script type="text/javascript">
	tinyMCE.init({
		...
		style_formats : [
			...
			{title : 'Red anchor', selector : 'a', classes : 'btn btn-default'}
		],
                  ...
                  <td><!-- start id-form -->
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                      <tr>
						...
						<tr>
							<th valign="top">Car Id 1:</th>
							<td><input type="text" class="inp-form" name="carid[]" id="carid1" value="<?php echo $carid[0] ;?>" /></td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						</tr>
						<tr>
							<th valign="top">Car Id 2:</th>
							<td><input type="text" class="inp-form" name="carid[]" id="carid2" value="<?php echo $carid[1];?>" /></td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						</tr>
						<tr>
							<th valign="top">Car Id 3:</th>
							<td><input type="text" class="inp-form" name="carid[]" id="carid3" value="<?php echo $carid[2] ;?>" /></td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						</tr>
						<tr>
							<th valign="top">Car Id 4:</th>
							<td><input type="text" class="inp-form" name="carid[]" id="carid4" value="<?php echo $carid[3] ;?>" /></td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						</tr>
						
						<tr>
							<th valign="top">Car Id 5:</th>
							<td><input type="text" class="inp-form" name="carid[]" id="carid5" value="<?php echo $carid[4] ;?>" /></td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						</tr>
						<tr>
							<th valign="top">Car Id 6:</th>
							<td><input type="text" class="inp-form" name="carid[]" id="carid6" value="<?php echo $carid[5] ;?>" /></td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						</tr>
						<tr>
							<th valign="top">Car Id 7:</th>
							<td><input type="text" class="inp-form" name="carid[]" id="carid7" value="<?php echo $carid[6] ;?>" /></td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						</tr>
						<tr>
							<th valign="top">Car Id 8:</th>
							<td><input type="text" class="inp-form" name="carid[]" id="carid8" value="<?php echo $carid[7] ;?>" /></td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						</tr>
						<tr>
							<th valign="top">Car Id 9:</th>
							<td><input type="text" class="inp-form" name="carid[]" id="carid9" value="<?php echo $carid[8];?>" /></td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						</tr>
						<tr>
							<th valign="top">Car Id 10:</th>
							<td><input type="text" class="inp-form" name="carid[]" id="carid10" value="<?php echo $carid[9] ;?>" /></td>
							<td><div class="error-left"></div>
							  <div class="error-inner">This field is required.</div></td>
						</tr>
						...
						<tr>
							...
							<td valign="top"><input type="submit" value="submit" name="submit" class="form-submit" />
							  <input type="button" class="form-reset" onclick="javascript:location.href='<?php echo DEFAULT_ADMIN_URL; ?>/home/product_banner.php'"/>
							</td>
							<td></td>
                        </tr>
                    </table>
