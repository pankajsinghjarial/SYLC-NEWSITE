      ...
      <table border="0" width="100%" cellpadding="0" cellspacing="0" id="content-table">
        ...
        <tr>
          ...
          <td><!--  start content-table-inner -->
			...
			<option value="<?php echo $page_cat['id']; ?>" <?php if($page_cat['id']==$page_catval) {?>selected<?php } ?>><?php echo $page_cat['name']; ?></option>
			<?php } ?>
			</select>
			</td>
			...
			<tr>
                      ...
                      <tr>
                        ...
                        <td><input type="text" class="inp-form" name="slug" id="slug" value="<?php echo $slug ;?>" /></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <th valign="top">Description:</th>
                        <td><textarea rows="" cols="" class="form-textarea myTextEditor" name="desc" id="desc"><?php echo $desc ;?></textarea></td>
                        <td><div class="error-left"></div>
                          <div class="error-inner">This field is required.</div></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><textarea rows="" cols="" class="form-textarea" name="metakeyword" id="metakeyword"><?php echo $metakeyword ;?></textarea></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <th valign="top">Meta Description:</th>
                        <td><textarea rows="" cols="" class="form-textarea" name="metadescription" id="metadescription"><?php echo $metadescription ;?></textarea></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <th>&nbsp;</th>
