...
$obj_setting = new common();echo
$total_rows = $obj_setting->numberOfRows('car_brands'); //number of rows in pages table
$allBrands = $obj_setting->customQuery("SELECT * FROM  car_brands order by $field $orderby limit $eu, $limit");
