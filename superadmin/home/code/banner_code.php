...
$obj_setting = new common();
$total_rows = $obj_setting->numberOfRows('rot_banner'); //number of rows in pages table
$allBanners = $obj_setting->customQuery("SELECT * FROM  rot_banner order by $field $orderby limit $eu, $limit");
