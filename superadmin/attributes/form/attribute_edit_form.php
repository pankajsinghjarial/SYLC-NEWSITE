...
/*  var ni = document.getElementById('myDiv');
  ...
  newdiv.innerHTML = '<tr><td><input type="text" name="att_value[]" class="inp-form"></td><td><input type="text" name="att_sort_order[]" class="inp-form"></td></tr>'; 
  	ni.appendChild(newdiv);*/
	var newdiv = '<tr><td><input type="text" class="inp-form" name="att_value[]" value=""/></td><td><input type="text" class="inp-form" name="att_sort_order[]" value=""/></td><td><a href="javascript:void(0)" onclick="removeElement(this);" >Remove</a></td></tr>'; 
$("#myDiv").append(newdiv);
}
function removeElement(id)
{
	$(id).parent().parent().fadeIn("slow").delay("slow").remove();
}
</script>
              ...
              <table border="0" width="100%" cellpadding="0" cellspacing="0">
                <tr valign="top">
                  <td><!-- start id-form -->
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                      ...
                      <tr>
                        ...
                        <td><input type="text" disabled="disabled" class="inp-form" name="att_code" id="att_code" value="<?php echo $code ;?>" onblur="setSlug();"/></td>
                 ...
                 <tr>
                        ...
                        <td><input type="radio" name="req" id="can_delete_yes" checked="checked" value="1"/>
                          Yes&nbsp;&nbsp;&nbsp;&nbsp;
                          <input type="radio" name="req" id="can_delete_no" value="0"/>
                          No </td>
                        <td>&nbsp;</td>
                      </tr>                      
                      <tr>
                        <th valign="top">Default Value:</th>
                        <td><input type="text" class="inp-form" name="att_def" id="att_def" value="" onblur="setSlug();"/></td>
                         <td>&nbsp;</td>
                      </tr>
                       <tr>
                        <th valign="top">Attribute Label:</th>
                        <td><input type="text" class="inp-form" name="att_label" id="att_label" value="" onblur="setSlug();"/></td>
                         <td>&nbsp;</td>
                      </tr>
                            	...
                            	<table>
                                    <tbody id="myDiv">
                                        <tr>
                                            ...
                                            <td valign="top"><a href="javascript:void(0)" onclick="addElement(this);">Add</a></th>
                                        </tr>
                                        <tr>
                                            <td><input type="text" class="inp-form" name="att_value[]" value=""/></td>
                                            <td><input type="text" class="inp-form" name="att_sort_order[]" value=""/></td>
                                            <td><a href="javascript:void(0)" onclick="removeElement(this);" >Remove</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
