        ...
        <td><!--  start content-table-inner ...................................................................... START -->
          <div id="content-table-inner">
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th width="35%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Name</a> </th>
                      <th width="20%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Code</a></th>
                      <th width="13%" class="table-header-repeat line-left"><a href="javascript:void(0)">Required</a></th>
                      <th width="7%" class="table-header-date line-left"><a href="javascript:void(0)">Published</a></th>
                       <th width="12%" class="table-header-date line-left"><a href="javascript:void(0)">Searchable</a></th>
				  ...
				  ?>
                    <tr <?php if($ii%2==0) echo 'class="alternate-row"';?>>
                      ...
                      <td><?php echo $getPageData->frontend_label;?></td>
                      <td><?php echo $getPageData->attribute_code;?></td>
                      <td><?php if($getPageData->is_required == 1 ){ echo "Yes"; } else { echo "No"; }?></td>
                      <td><?php if($getPageData->publish == 1 ){ echo "Yes"; } else { echo "No"; }?></td>
                      <td><?php if($getPageData->searchable == 1 ){ echo "Yes"; } else { echo "No"; }?></td>
                      <td><a href="edit.php?id=<?php echo $getPageData->attribute_id.$addToPagging;?>" title="Edit" class="icon-1 info-tooltip"></a>
                      </td>
                    </tr>
                    <?php $ii++; 
				 	  } 
            ...
            <div id="actions-box"> <a href="" class="action-slider"></a>
              <div id="actions-box-slider"> <a href="#" class="action-edit" onclick="return checkBoxCheckedForEdit();">Edit</a> </div>
              <div class="clear"></div>
            </div>
            <!-- end actions-box........... -->
            <!--  start paging..................................................... -->
