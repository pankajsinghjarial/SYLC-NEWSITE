                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th width="33%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Question</a> </th>
                      <th width="28%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Answer</a></th>
                      <th width="5%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Status</a></th>
                      <th width="20%" class="table-header-repeat line-left"><a href="javascript:void(0)">Created On</a></th>
				  ...
				  ?>
                    <tr <?php if($ii%2==0) echo 'class="alternate-row"';?>>
                      ...
                      <td><?php echo $getPageData->question;?></td>
                        <td><?php if($getPageData->answer == 0 ){ echo "Car Enquiry"; } else { echo "Genral Enquiry"; }?></td>
                      <td><?php if($getPageData->publish == 0 ){ echo "Unread"; } else { echo "Read"; }?></td>
                      <td><?php echo date("d-m-Y",$getPageData->creation_date);?></td>
