...
$total_rows = $obj_setting->numberOfRows('users'); //number of rows in pages table
$all_pages = $obj_setting->customQuery("SELECT * FROM users order by $field $orderby limit $eu, $limit ");
