                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th width="13%" class="table-header-options line-left minwidth-1"><a href="javascript:void(0)" style="background:none">Date</a></th>
                      <th width="33%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Name</a> </th>
                      <th width="25%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Email</a></th>
                      <th width="18%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Phone Number</a></th>
                      
                      <th width="5%" class="table-header-options line-left"><a href="javascript:void(0);">Options</a></th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php 
				  ...
				  ?>
                    <tr <?php if($ii%2==0) echo 'class="alternate-row"';?>>
                      ...
                      <td><?php echo date("d-M-Y",strtotime($getPageData->created));?></td>
                      <td><?php echo $getPageData->name;?></td>
                      <td><?php echo $getPageData->email;?></td>
                      <td><?php echo $getPageData->phone_number;?></td>
                      
                      <td><a href="userview.php?id=<?php echo $getPageData->id.$addToPagging;?>" title="View User" class="icon-3 info-tooltip"></a>
