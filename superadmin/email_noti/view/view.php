...
<div id="content-outer">
  ...
  <div id="content">
    <!--  start page-heading -->
    <div id="page-heading">
      <h1>Email Notification Manager</h1>
          ...
          <div id="content-table-inner">
            ...
            <div id="table-content">
              ...
              <form id="mainform" action="multiple_delete.php" method="post">
                <a href="<?php echo DEFAULT_ADMIN_URL; ?>/email_noti/add.php" class="">Add New Email</a>
		<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th  class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)" style="background: none">Email Address</a> </th>
				  ...
				  if($total_rows > 0){
				  $ii =1;
				  while($emails = mysql_fetch_object($all_emails)){  //echo "<pre>";print_r($ip);die;
				  ?>
                    <tr <?php if($ii%2==0) echo 'class="alternate-row"';?>>
                     <!-- <td><input  type="checkbox" name="allselect[]" class="case" id="allselect<?php echo $ip->id;?>" value="<?php echo $ip->id;?>"/></td>-->
                      ...
                      <td><?php echo date(DEFAULT_DATE_FORMAT,strtotime($emails->created));?></td>
                      <td>
                        
                        <a href="delete.php?id=<?php echo $emails->id.$addToPagging;?>" title="Delete" class="icon-2 info-tooltip"></a>
