...
$total_rows = $obj_setting->numberOfRows('notification_emails'); //number of rows in pages table

$all_emails = $obj_setting->customQuery("SELECT * FROM notification_emails order by $field $orderby limit $eu, $limit ");
