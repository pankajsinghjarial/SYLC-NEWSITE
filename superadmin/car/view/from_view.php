...
<div id="content-outer"> 
  ...
  <div id="content"> 
    <!--  start page-heading -->
    <div id="page-heading">
      <h1>Car List From <?php echo $site; ?></h1>
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
				  ...
				  ?>
                    <tr <?php if($ii%2==0) echo 'class="alternate-row"';?>>
                      ...
                      <td><a href="view.php?id=<?php echo $getPageData['id'];?>" title="View" class="icon-3 info-tooltip"></a> <a href="edit.php?id=<?php echo $getPageData['id'];?>" title="Edit" class="icon-1 info-tooltip"></a> <a href="<?php echo DEFAULT_ADMIN_URL?>/car/delete.php?car_id=<?php echo $getPageData['id'];?>&action=delete" title="Delete" class="icon-2 info-tooltip"  onclick="return confirm('Are you sure you want to delete.');"></a></td>
                    </tr>
                    <?php $ii++; 
				 	  } 
					 }else{
