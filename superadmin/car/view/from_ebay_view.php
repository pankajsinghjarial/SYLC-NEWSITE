                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  ...
                  <tbody>
				   ...
				   foreach( $resp->searchResult->item as $item ) {
					...
					$buyItNowPrice = (int) $item->sellingStatus->convertedCurrentPrice;
					if($item->listingInfo->buyItNowAvailable == 'true'){
						$buyItNowPrice = (int) $item->listingInfo->buyItNowPrice;
					}
                    ...
                    <tr <?php if($ii%2==0) echo 'class="alternate-row"';?>>
                      ...
                      <td><img alt="<?php echo $title;?>" src="<?php echo DEFAULT_URL; ?>/image_resizer.php?img=<?php echo urlencode($galleryURL); ?>&newWidth=87&newHeight=54" width="87" height="54"></td>
