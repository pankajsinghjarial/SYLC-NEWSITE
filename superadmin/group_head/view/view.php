  ...
  <div id="content_main" class="clearfix">
    <div style="width:78%; float:left;">
      <div id="dashboard">
        <table width="100%">
          <tr>
            <td valign="top" style="padding:0 0 6px 0;"><div style="float:left; padding:5px 0 0 0;" class="page_head"><span>Group-Head Manager</span></div>
              <div style="float:right;"><a href="<?= DEFAULT_ADMIN_URL;?>/group_head/add.php"><img src="<?php echo ADMIN_IMAGE_URL; ?>/plus.jpg" align="absmiddle" title="Add New"/></a></div></td>
          </tr>
        </table>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #CCCCCC" class="display" id="example">
            <thead>
              <tr>
                ...
                <th width="247" align="center" valign="top" scope="col"> Name </th>
                <th width="209" align="center" valign="top" scope="col"> Phone No</th>
	...
	?>
        ...
        if($fetch->status==1){?>
                ...
                <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="inner_table">
                    <tr>
                      <td align="left" valign="top"><a href="<?= DEFAULT_ADMIN_URL;?>/group_head/update.php?prod_id=<?= $fetch->id;?>"><img src="<?= ADMIN_IMAGE_URL;?>/edit.gif" width="16" height="16" alt="Edit Product"  border="0" title="Edit Product"/></a></td>
                      <td align="left" valign="top"><a href="?pid=<?= $fetch->id;?>&action=delete"><img src="<?= ADMIN_IMAGE_URL;?>/delete.gif" width="13" height="13" alt="Add More Images" border="0" title="Add More Images" /></a></td>
