...
<div id="content-outer">
  ...
  <div id="content">
    ...
    <div id="page-heading" style="width:1211px;">
      <h1 style="float:left;">Brand Manager</h1>
    <div style="float:right;"><a href="<?= DEFAULT_ADMIN_URL;?>/new_stock/brands/add.php"><img src="<?php echo ADMIN_IMAGE_URL; ?>/forms/icon_plus.gif" align="absmiddle" title="Add New"/></a></div></td>
                ...
                <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th width="45%" class="table-header-repeat line-left minwidth-1"><a href="javascript:void(0)">Brand Name</a> </th>
                      <th width="20%" class="table-header-repeat line-left"><a href="javascript:void(0)">Publish</a></th>
                      <th width="20%" class="table-header-repeat line-left"><a href="javascript:void(0)">Date</a></th>
                      <th width="18%" class="table-header-options line-left"><a href="javascript:void(0);">Options</a></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php 
				  if(mysql_num_rows($getBlock) > 0){
				  $ii =1;
				  while($getPageData = mysql_fetch_object($getBlock)){ 
				  ?>
                    <tr <?php if($ii%2==0) echo 'class="alternate-row"';?>>
                      ...
                      <td><?php if($getPageData->publish == 0 ){ echo "No"; } else { echo "Yes"; }?></td>
                      <td><?=date(DEFAULT_DATE_FORMAT,$getPageData->creation_date)?></td>
                      
                      <td><a href="update.php?brand_id=<?php echo $getPageData->id.$addToPagging;?>" title="Edit" class="icon-1 info-tooltip"></a>
                         <a onclick="return confirm('Are you sure you want to delete.');" href="?bid=<?php echo $getPageData->id.$addToPagging;?>&action=delete" title="Delete" class="icon-2 info-tooltip"></a>
                      </td>
                    </tr>
                    <?php $ii++; 
				 	  } 
