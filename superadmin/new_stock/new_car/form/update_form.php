                    ...
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                      ...
                      <tr>
                        ...
                        <td> <select name="stockType" class="select-form required">
                                <option value="" <?php if($stockType == ''){echo 'selected="selected"';}?>>Select Type</option>
                                <option value="neuf" <?php if($stockType == 'neuf'){echo 'selected="selected"';}?>>Neuf</option> 
                                <option value="classic" <?php if($stockType == 'classic'){echo 'selected="selected"';}?>>Classic car</option> 
                            </select></td>
                        <td><div class="error-left"></div>
                          <div class="error-inner">This field is required.</div></td>
                        <td>&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <img src="<?=DEFAULT_URL?>/images/brands/<?=$old_image?>" width="30" height="30"/>
