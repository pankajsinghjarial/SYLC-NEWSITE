...
if(isset($pid) && $action=='delete'){
	//echo $pid; die;
$objCommon->delete('upsell','id='.$pid);
  $_SESSION['msg']='Deleted Successfully';
  echo '<script>location.href="'.DEFAULT_ADMIN_URL.'/upsell/index.php";</script>'; 
    exit;

  }
$statusInfot = $objCommon->read('upsell','',"id DESC");
...
/* Get data. */
$statusInfo = $objCommon->read('upsell','',"id DESC limit $start, $limit");
