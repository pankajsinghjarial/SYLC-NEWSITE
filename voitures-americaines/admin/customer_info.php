...
<script type="text/javascript">
	...
	function CuteWebUI_AjaxUploader_OnPostback()
	{
		...
		var uploader = document.getElementById("myuploader"+$("#tabs a#current").attr("data-ref"));
		...
		var filelist = document.getElementById("filelist"+$("#tabs a#current").attr("data-ref"));
...
<?php */?> 
  ...
  <!--start vehicle_box -->
    ...
    $modelname = $carfetch->model;
      	?>
      <li><a href="#" name="#tab<?php echo $i;?>"  data-ref="<?php echo $i;?>"><?php echo $carname." ".$modelname; ?></a></li>
...
echo "Contract Received- ".date('m/d/Y',strtotime($carfetch->sign_date));
 ...
 <a style="text-decoration: none;" href="<?php echo DEFAULT_URL?>/pop_form_details.php?id=<?php echo $id?>&lead_id=<?php echo $carfetch->id?>&from=admin"><input type="button" class="order_now_bt" style="float: right;margin-bottom: 0" name="Order Now" value="Send Contract"/></a>
 <?php }else { ?>
  <a style="text-decoration: none;" href="<?php echo DEFAULT_URL?>/pop_form_details.php?id=<?php echo $id?>&lead_id=<?php echo $carfetch->id?>&from=admin"><input type="button" class="order_now_bt" style="float: right;margin-bottom: 0" name="Order Now" value="Resend Contract"/></a>
 <?php }?>
...
{ ?>
  <tr>
    ...
    <td><a href="<?php echo DEFAULT_URL?>/download.php/?file=<?php echo $docdetailfetch->docname?>"><?php echo $docdetailfetch->docname;?></a></td>
...
<div id="p_scents<?php echo $j;?>">
 ...
 <div class="demo"> 
			<?php
				$upload_obj = "myuploader".$j;
			
				$$upload_obj=new PhpUploader();
				$$upload_obj->MaxSizeKB=10240;
				$$upload_obj->Name=$upload_obj;
				$$upload_obj->MultipleFilesUpload=true;
				$$upload_obj->SaveDirectory=LIST_ROOT.'/gallery/';
				$$upload_obj->InsertText="Select multiple files (Max 10M)";
				$$upload_obj->AllowedFileExtensions="*.jpg,*.png,*.gif";	
				$$upload_obj->Render();
				
			?>
					
			<ol id="filelist<?php echo $j;?>">
