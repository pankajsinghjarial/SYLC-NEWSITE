  ...
  //$model = $_POST['model'];
  //$car_brand = $_POST['firstlevel'];
  $current_time = $_POST['currenttime_canada'];
  //$year_for_admin = $_POST['admin_year_pop'];

  //$dealer_fees_pop = $_POST['dealer_fees_pop'];
  //$doc_fees_pop = $_POST['doc_fees_pop'];
  //$bank_fees_pop = $_POST['bank_fees_pop'];
  //$deposit_pop = $_POST['deposit_pop'];
  //$subtotal_pop = $_POST['subtotal_pop'];
  //$total_pop = $_POST['total_pop'];
  //$deposit_percent_pop = $_POST['deposit_percent_pop'];
  //$balance_pop = $_POST['balance_pop'];
 

if($hiddenpop=='hiddenformvalue')
{
	 $sql="INSERT INTO `leads`(name,first_name,email,phone,car_brand1,car_model1,year,service,created_at) VALUES ('". $lastnameforpopup ."','". $nameforpopup ."','". $emailforpopup ."','". $phonepop ."','". $car_brand1 ."','". $car_model1 ."','". $car_year ."','". $service ."','". $current_time ."');";
...
//dealer_fees = '".$dealer_fees_pop."',
//doc_fees = '".$doc_fees_pop."',
//bank_fees = '".$bank_fees_pop."',
//deposit = '".$deposit_pop."',
//subtotal = '".$subtotal_pop."'

//,
//total = '".$total_pop."',
//deposit_percent = '".$deposit_percent_pop."',
		//balance = '".$balance_pop."'
?>
