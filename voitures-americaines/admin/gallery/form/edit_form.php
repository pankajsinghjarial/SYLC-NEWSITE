  ...
  <div style="margin:auto; width:500px; height:auto; padding:20px 0 0 0;">
    ...
    <table width="100%" border="0" bgcolor="#fafafa" align="center" cellpadding="0" cellspacing="0" >
      ...
      <tr>
        ...
        <td align="center" bgcolor="#747474" class="style7 style12" style="padding:10px 0;"><strong>Edit Gallery</strong></font></td>
                    ...
                    <tr>
                      ...
                      <td width="100%"><table width="100%" border="0" cellspacing="2" cellpadding="2">
                          ...
                          <tr>
                            ...
                            <td width="15%" height="31" align="right"><strong>Car Name</strong>&nbsp;</td>

                            <td width="5%"><strong>:</strong></td>

                            <td><input type="text" name="car_name" id="car_name" value="<?php echo $car_name?>"/>
                    ...
                    <tr>
                      ...
                      <td width="100%"><table width="100%" border="0" cellspacing="2" cellpadding="2">
                          ...
                          <tr>
                            ...
                            <td width="15%" height="31" align="right" valign="top"><strong>Image</strong>&nbsp;</td>

                            <td width="5%" valign="top"><strong>:</strong></td>

                            <td><input type="file" name="image" id="fees" size='17'/><br/>
                             <img src="<?php echo DEFAULT_URL."/gallery/".$oldimage?>" <?php echo imageResize($mysock[0],$mysock[1], 100); ?> />
