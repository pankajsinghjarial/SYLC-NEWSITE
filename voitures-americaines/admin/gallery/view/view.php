...
<table width="100%">
<tr>
<td align="left" width="60%" style="color: #A8C076;"><strong>Gallery Manager</strong></td>
<td><div style="float:right;"><a href="<?php echo DEFAULT_ADMIN_URL?>/gallery/add.php"><img align="absmiddle" title="Add New" src="<?php echo DEFAULT_ADMIN_URL?>/images/plus.jpg"></a></div></td>
</tr>
...
?>
          <td><form name="frm_manu_list" id="frm_manu_list" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" onsubmit="return validform( this ) ;">
			...
			<thead>
			<tr>
        	      <th align="center" bgcolor="#A8C076" style="padding:10px 0;" class="wel_text1"><span class="style9">Car Name</span></th>
                  <th align="center" bgcolor="#A8C076" style="padding:10px 0;" class="wel_text1"><span class="style9">Image</span></th>
                ...
                <?php while($arr_sel=mysql_fetch_array($statusInfo)) 

				                    {
	                                 ...
	                                 $id=$arr_sel['id']; 
	                               	 $mysock = getimagesize(DEFAULT_URL."/gallery/".$arr_sel['image_name']);
	                               	              	?>
 

                <tr >
                   <td align="center" bgcolor="#fafafa" style="padding:5px;"><strong><font color="#666666"><?php echo($arr_sel['car_name']);?></font></strong></td>
                 <?php /*?> <td align="center" bgcolor="#fafafa" style="padding:5px;"><strong><font color="#666666"><?php echo($arr_sel['first_name']);?></font></strong></td><?php */?>
                  <td align="center" bgcolor="#fafafa" style="padding:5px;"><img src="<?php echo DEFAULT_URL."/gallery/".$arr_sel['image_name']?>" <?php echo imageResize($mysock[0],$mysock[1], 100); ?>></td>
...
<td align="center" bgcolor="#fafafa" style="padding:5px;"><a href="<?php echo DEFAULT_URL?>/admin/gallery/edit.php?pid=<?php echo $id;?>&action=edit" title="Delete"" title="Edit"><img src="<?php echo DEFAULT_ADMIN_URL?>/images/edit.gif" /></a>&nbsp;&nbsp;&nbsp;&nbsp; <a onclick="return confirm('Are you sure want to delete?');" href="<?php echo DEFAULT_ADMIN_URL?>/gallery/index.php?pid=<?php echo $id;?>&action=delete" title="Delete"><img src="<?php echo DEFAULT_ADMIN_URL?>/images/delete.gif" /></a></td>
