...
$row = 1;
if (($handle = fopen("temp-uploads/fees1.csv", "r")) !== FALSE) {
...
include_once(LIST_ROOT_ADMIN."/gallery/code/edit_code.php"); ?>
<link href="<?php echo DEFAULT_ADMIN_URL?>/images/favicon.ico" rel="shortcut icon" type="image/ico" ><?php
include(LIST_ROOT_ADMIN."/gallery/form/edit_form.php");  
