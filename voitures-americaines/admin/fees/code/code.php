...
if(isset($pid) && $action=='delete'){
	//echo $pid; die;
$objCommon->delete('fees','id='.$pid);
  $_SESSION['msg']='Deleted Successfully';
  echo '<script>location.href="'.DEFAULT_ADMIN_URL.'/fees/index.php";</script>'; 
    exit;

  }

$statusInfot = $objCommon->read('fees','',"id DESC");
...
/* Get data. */
$statusInfo = $objCommon->read('fees','',"id DESC limit $start, $limit");
