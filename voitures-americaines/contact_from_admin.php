...
$entryfromadmin = $_POST['admin_lead_entry'];
...
$sql="INSERT INTO `leads`(name,first_name,email,phone,car_brand,model,car_brand1,car_model1,year,service,created_at) VALUES ('". $name ."','". $first_name ."','". $email ."','". $phone ."','". $car_brand ."','". $model ."','". $car_brand ."','". $model ."','". $year ."','". $service ."','". $current_time ."');";
...
<script language="javascript">location.href='<?php echo DEFAULT_ADMIN_URL;?>/user_info.php?msg=1'</script>	
