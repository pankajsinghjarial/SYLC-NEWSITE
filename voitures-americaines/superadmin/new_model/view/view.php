<div id="content" >
  ...
  <div class="left_admin">
      <div id="dashboard">
        <table width="100%">
          <tr>
            <td valign="top" style="padding:0 0 6px 0;"><div style="float:left; padding:5px 0 0 0;" class="page_head"><span>New Model Manager</span></div>
              <div style="float:right;"><a href="<?= DEFAULT_ADMIN_URL;?>/new_model/add.php"><img src="<?php echo ADMIN_IMAGE_URL; ?>/plus.jpg" align="absmiddle" title="Add New"/></a></div></td>
          </tr>
        </table>
...
?>
	...
	?>
              <tr>
                ...
                <td align="center" valign="top"><?= $fetch->brand_name ;?></td>
        ...
        if($fetch->publish==1){?>
                ...
                <li><a href="<?= DEFAULT_ADMIN_URL;?>/new_model/update.php?model_id=<?= $fetch->id;?>"><img src="<?= ADMIN_IMAGE_URL;?>/edit.gif" width="16" height="16" alt="Edit This Record"  border="0" title="Edit This Record"/></a></li>
