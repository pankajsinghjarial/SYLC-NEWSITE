<div id="content" >
  ...
  <div class="left_admin">
      <div id="dashboard">
        <table width="100%">
          <tr>
            <td valign="top" style="padding:0 0 6px 0;"><div style="float:left; padding:5px 0 0 0;" class="page_head"><span>Car Template Manager</span></div>
              <div style="float:right;"><a href="<?= DEFAULT_ADMIN_URL;?>/htmltemplate/add.php"><img src="<?php echo ADMIN_IMAGE_URL; ?>/plus.jpg" align="absmiddle" title="Add New"/></a></div></td>
          </tr>
        </table>
...
?>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #CCCCCC" class="display main_data_used_manager" id="example">
            <thead>
              <tr>
                ...
                <th width="247" align="center" valign="top" scope="col"> Title</th>
                <th width="209" align="center" valign="top" scope="col"> Price</th>
	...
	?>
              <tr>
                ...
                <td align="center" valign="top"><?= $fetch->price ;?></td>
        ...
        if($fetch->publish==1){?>
                ...
                <li><a href="<?= DEFAULT_ADMIN_URL;?>/htmltemplate/update.php?model_id=<?= $fetch->id;?>"><img src="<?= ADMIN_IMAGE_URL;?>/edit.gif" width="16" height="16" alt="Edit This Record"  border="0" title="Edit This Record"/></a></li>
                    <li> <a href="?model_id=<?= $fetch->id;?>&action=delete" onclick="return confirm('Are you sure you want to delete');"><img src="<?= ADMIN_IMAGE_URL;?>/delete.gif" width="13" height="13" alt="Delete This Record" border="0" title="Delete This Record" /></a></li>
                      </ul>
