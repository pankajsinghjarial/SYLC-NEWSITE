...
?>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #CCCCCC" class="display main_data_brand" id="example">
            <thead>
              <tr>
	...
	?>
        ...
        if($fetch->publish=='yes'){?>
              ...
              <li> <a href="<?= DEFAULT_ADMIN_URL;?>/brands/update.php?brand_id=<?= $fetch->id;?>"><img src="<?= ADMIN_IMAGE_URL;?>/edit.gif" width="16" height="16" alt="Edit This Block"  border="0" title="Edit This Block"/></a></li>
