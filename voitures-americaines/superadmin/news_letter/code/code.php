...
$full_data = '<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 $full_data .= '<tr>
    <td align="center" valign="top"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr>
          <td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#4c5051; line-height:18px; padding:10px 0 18px 0; border-bottom:2px dashed #e8e8e8;">'.htmlentities($used_car_text->used_car_text).'</td>
        </tr>
      </table></td>
  </tr>
  <tr>
    <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
       ...
       $full_data .= '<tr>
                ...
                <td align="center" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#2e2e2e; padding:14px; border-right:1px solid #e1e1e1; border-bottom:1px solid #e1e1e1;"><img src="http://www.sylc-export.com/voitures-americaines/superadmin/images/used_car/image/'.$used_cars->image.'" alt=" " width="137" height="59" border="0" /></td>
                <td align="center" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#2e2e2e; padding:14px; border-right:1px solid #e1e1e1; border-bottom:1px solid #e1e1e1;"><img src="http://www.sylc-export.com/voitures-americaines/superadmin/images/used_car/dispo/'.$used_cars->dispo.'" alt="auto trader" width="89" height="33" border="0" /></td>
