  ...
  <div id="content_main" class="clearfix">
    <div style="width:78%; float:left;">
      <form action="<?=$_SERVER['REQUEST_URI'];?>" method="post" name="add_form" id="add_form" enctype="multipart/form-data" >
        <div id="dashboard"><span class="page_head">Banner Image</span></div>
        <?php
        ...
        <legend>Banner Image<font color="#FF0000">*</font></legend>
        
        <input type="file" name="banner_image" id="banner_image" />&nbsp;&nbsp;&nbsp;&nbsp;( Preferred image size : 763 X 247 px )
        
        <?php if($old_image!='' && file_exists(LIST_ROOT_ADMIN.'/images/banner_template/'.$old_image)) {
		$imageInfo=getimagesize(DEFAULT_ADMIN_URL.'/images/banner_template/'.$old_image);
		$imgWidth=$imageInfo[0];
		if($imgWidth>900)
			$imgWidth='900px';
		?>
        <br /><br />
        	<img src="<?=DEFAULT_ADMIN_URL?>/images/banner_template/<?=$old_image?>" width="<?php echo $imgWidth; ?>" />        
        <?php }?>
        <br />
        <br />
        </fieldset>
